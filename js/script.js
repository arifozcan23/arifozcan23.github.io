...
const translations = {
    'tr': {
        ...
        'education_se': 'Yazılım Mühendisliği (GPA: 3.04/4)',
        'education_se_school': 'Fırat Üniversitesi',
        'education_erasmus': 'Erasmus+ Değişim Programı (Portekiz)',
        ...
        'experience_fulldev': 'Full Stack Developer',
        'experience_company4': 'ISSD Bilişim Elektronik A.Ş.',
        'experience_desc9': '• Trafik yönetim sistemlerinin web geliştirme çalışmalarında görev alıyorum. Kavşaklarda ve ilgili cihazlarda ilgili trafik verilerinin görüntülenmesi ve yönetilmesine yönelik özellikler geliştiriyorum.',
        ...
        'experience_desc8': '• Agile ve Scrum koçluğu alarak gelişimime büyük bir yatırım yaptım.',
        'experience_webdev': 'Yazılım Mühendisi Stajyeri - Uzun Dönem',
        'experience_company2': 'T.C. Gelir İdaresi Başkanlığı - GİB Teknoloji',
        'experience_desc3': '• Spring Boot kullanarak, bir kamu kurumunun yapısına uygun, kurumsal düzeyde bir arka uç uygulaması (Personel Takip Sistemi) geliştirdim.',
        'experience_desc4': '• Proje yenileme ekibinde kıdemli mentor mühendislerle iş birliği yaparak, görev odaklı iterasyonlarla arka uç servislerini tasarladım, geliştirdim ve optimize ettim; bu süreçte SOLID prensiplerini uyguladım ve CI/CD araçlarını kullandım.',
        'experience_desc5': '• RESTful API geliştirme, veritabanı yönetimi ve katmanlı mimari konularında en iyi uygulamaları kullanarak sistem güvenliğini rol tabanlı yetkilendirme ile güçlendirdim ve önceden tanımlı kurallara dayalı otomatik e-posta bildirimleri sağladım.',
        'experience_jrdev': 'Yazılım Mühendisi Stajyeri',
        'experience_company1': 'T.C. Gelir İdaresi Başkanlığı - GİB Teknoloji',
        'experience_desc1': '• Java geliştirme becerilerimi güçlendirdim ve yazılım geliştirme yaşam döngüsü, çevik metodolojiler, tasarım kalıpları, yazılım mimarileri ve teorik bilginin endüstri standardı uygulamalara nasıl dönüştüğü konusunda pratik bilgiler edindim.',
        'experience_desc2': '• Gerçek dünya yazılım geliştirmede teorik bilgi kazandım ve ülke çapındaki projelerin ardındaki mantığı daha derinlemesine anladım.',
        ...
        'quote2_author': 'Şair',
        'quote3': '"Hayattan beklentilerimi minimize etmeyi öğrendim ben, minimize."',
        'quote3_author': 'Teknik Direktör',
        'quote4': '"Sormaz ki bilsin, sorsa bilirdi; Bilmez ki sorsun, bilse sorardı."',
        'quote4_author': 'Şair',
        'quote5': '"Seni parlayacaksa parlasın yıldızlar; Sana yanmayan yıldızı semalarda istemem."',
        'quote5_author': 'Padişah',
        'quote6': '"Yapmak istediğimi sakalımın bir teli bile bilseydi, sakalımın o telini hemen koparır ve yakardım."',
        'quote6_author': 'Padişah',
        'quote7': '"Zulm ile âbâd olanın, âhiri berbâd olur."',
        'quote7_author': 'Şair',
        'quote8': '"Düşmanınla barışmak istiyorsan, düşmanınla birlikte çalışmalısın. O zaman o senin ortağın olur."',
        'quote8_author': 'Devlet Başkanı',
        'quote9': '"Bazen olmaz. Olmuyorsa olabilir, çabalamak lazım."',
        'quote9_author': 'Anonim',
        // Portfolio sayfası
        'portfolio_title': 'Portföyüm',
        'portfolio_subtitle': 'İşte bazı projelerim ve çalışmalarım',
        'project1_title': 'Bir Dakika Dinle',
        'project1_desc': 'Türkçe öğrenmek isteyenler için belirli konuların hem metinlerini hem de sesli versiyonlarını sunan bir dinleme platformudur. Platform, Türkçe öğrenmeyi kolaylaştırmak amacıyla konulara göre sınıflandırılmış içerikleri dinleme ve okuma (transkript) imkânı ile birlikte sunar.',
        'project2_title': 'Personel Takip Sistemi',
        'project2_desc': 'Personel, birimler, kapılar, turnikeler ve çalışma saatlerini yönetmek için tasarlanmış kapsamlı bir arka uç projesi, kolay erişim kontrolü, e-posta bildirimi ve maaş hesaplaması sağlar.',
        'project3_title': 'Shadowise Öğrenim Uygulaması',
        'project3_desc': 'Kullanıcıların yüklediği PDF belgelerinden yapay zeka desteği ile otomatik olarak test soruları, flash kartlar ve özetler oluşturan bir Spring Boot uygulamasıdır. Öğrenme süreçlerini optimize etmek için tasarlanmıştır.',
        'project4_title': 'Yapay Zeka Destekli Yazı Dağıtım Sistemi',
        'project4_desc': 'Gelen resmi belgeleri analiz etmek ve bunları uygun üniversite bölümlerine otomatik olarak yönlendirmek için yapay zeka destekli bir platform oluşturdu. SAYZEK (Savunma Sanayii Yapay Zeka Yetenek Kümesi) tarafından desteklenmektedir.',
        'project5_title': 'Yüz Şekline Göre Gözlük Öneri Uygulaması',
        'project5_desc': 'Kullanıcının yüz şeklini tanımlayan ve yüz tipine uygun gözlük çerçeveleri öneren bir yapay zeka uygulaması tasarladı.',
        'project6_title': 'Uçuş Takip Uygulaması',
        'project6_desc': 'OpenSky Network API\'sını kullanarak dünya çapındaki uçuşların mevcut konumlarını harita üzerinde gösterme ve uçuş verilerini grafik yapılarıyla görselleştirme.',
        'project7_title': 'Konsolosluk Randevu Sistemi',
        'project7_desc': 'Konsolosluk Randevu Sistemi, kullanıcıların farklı ülkelerin konsolosluk bilgilerine erişmesini, vize türlerini öğrenmesini ve vize başvurusu yapabilmesini sağlayan kapsamlı bir Android mobil uygulamasıdır.',
    ...
    'en': {
        ...
        'education_se': 'Software Engineering (GPA: 3.04/4)',
        'education_se_school': 'Fırat University',
        'education_erasmus': 'Erasmus+ Exchange Programme (Portugal)',
        'education_erasmus_school': 'University of Beira Interior',
        ...
        'experience_fulldev': 'Full Stack Developer',
        'experience_company4': 'ISSD Bilişim Elektronik A.Ş.',
        'experience_desc9': '• I am involved in the web development of traffic management systems. I develop features regarding the display and management of relevant traffic data at junctions and releated devices.',
        'experience_javadev': 'Java Backend Developer - Part time',
        'experience_company3': 'Craft Technology',
        ...
        'experience_desc8': '• I made a big investment in my development by receiving Agile and Scrum coaching.',
        'experience_webdev': 'Software Engineer Intern - Long Term',
        'experience_company2': 'T.C. Gelir İdaresi Başkanlığı - GİB Teknoloji',
        'experience_desc3': '• I developed an enterprise-level backend application (Personnel Tracking System) using Spring Boot, designed to align with the structure of a public institution.',
        'experience_desc4': '• Collaborated with senior mentor engineers in the project renewal team through task-oriented iterations, designing, developing, and optimizing back-end services by applying SOLID principles and using CI/CD tools.',
        'experience_desc5': '• Applied best practices in RESTful API development, database management, and layered  architecture to enhance system security with role-based authorization and enable automated email notifications based on predefined rules.',
        'experience_jrdev': 'Software Engineer Intern',
        'experience_company1': 'T.C. Gelir İdaresi Başkanlığı - GİB Teknoloji',
        'experience_desc1': '• Strengthened Java development skills and gained practical insights into the software development lifecycle, agile methodologies, design patterns, software architectures, and how theoretical knowledge translates into industry-standard applications.',
        'experience_desc2': '• Gained theoretical knowledge in real-world software development and deepened understanding of the logic behind nationwide projects.',
        ...
        'quote2_author': 'Poet',
        'quote3': '"I learned to minimize my expectations from life, minimize."',
        'quote3_author': 'Technical Director',
        'quote4': '"He doesn\'t ask to know, if he asked he would know; He doesn\'t know to ask, if he knew he would ask."',
        'quote4_author': 'Poet',
        'quote5': '"Let the stars shine if they will shine for you; I do not want a star in the heavens that does not shine for you."',
        'quote5_author': 'Sultan',
        'quote6': '"If even a single hair of my beard knew what I wanted to do, I would immediately pluck that hair and burn it."',
        'quote6_author': 'Sultan',
        'quote7': '"He who prospers through oppression will ultimately face ruin."',
        'quote7_author': 'Poet',
        ...
        'project1_title': 'Bir Dakika Dinle',
        'project1_desc': 'A listening platform that provides both text and audio versions of specific topics for those who want to learn Turkish. The platform offers both listening and reading (transcript) opportunities, organized by topics to facilitate Turkish learning.',
        'project2_title': 'Personnel Tracking System',
        'project2_desc': 'A comprehensive backend project designed to manage personnel, departments, doors, turnstiles, and working hours, providing easy access control, email notifications, and salary calculations.',
        'project3_title': 'Shadowise Learning Application',
        'project3_desc': 'A Spring Boot application that automatically generates test questions, flashcards, and summaries from PDF documents uploaded by users with AI support. It is designed to optimize learning processes.',
        'project4_title': 'AI-Supported Document Distribution System',
        'project4_desc': 'Created an AI-powered platform to analyze incoming official documents and automatically route them to appropriate university departments. Supported by SAYZEK (Defense Industry Artificial Intelligence Capability Cluster).',
        'project5_title': 'Face Shape Based Glasses Recommendation App',
        'project5_desc': 'Designed an artificial intelligence application that identifies the user\'s face shape and recommends eyeglass frames suitable for their face type.',
        'project6_title': 'Flight Tracking Application',
        'project6_desc': 'Displaying the current positions of flights worldwide on a map and visualizing flight data with graphical structures using the OpenSky Network API.',
        'project7_title': 'Consulate Appointment System',
        'project7_desc': 'Consulate Appointment System is a comprehensive Android mobile application that allows users to access consulate information of different countries, learn about visa types and apply for visas.',
